...
def git_update():
    ...
    sudo("""
         touch /var/log/apache2/djopenid-wsgi.log
         chown www-data /var/log/apache2/djopenid-wsgi.log
         """
        )
